...
class EcommerceRepo {
  ...
  Future<ProductModel> fetchAllProduct({
    ...
    try {
      Dio dio = DioManager.shared.getClient();
      Response response = await dio.get("https://api-ecommerce-general.inovatiftujuh8.com/ecommerces/v1/products/all?page=$page&limit=5&search=$search&app_name=raksha&cat=$cat");
      Map<String, dynamic> data = response.data;
  ...
  Future<ProductModel> fetchAllProductSeller({
    ...
    try {
      Dio dio = DioManager.shared.getClient();
      Response response = await dio.get("https://api-ecommerce-general.inovatiftujuh8.com/ecommerces/v1/products/seller/all?page=$page&limit=5&search=$search&app_name=raksha&store_id=$storeId&cat=$cat");
      Map<String, dynamic> data = response.data;
      ProductModel productModel = ProductModel.fromJson(data);
      return productModel;
    } on DioError catch(e) {
  ...
  Future<ProductCategoryModel> fetchProductCategory() async {
    try {
      Dio dio = DioManager.shared.getClient();
      Response response = await dio.get("https://api-ecommerce-general.inovatiftujuh8.com/ecommerces/v1/products/category?app_name=raksha");
      Map<String, dynamic> data = response.data;
