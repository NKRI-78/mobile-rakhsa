...
class DetailOrderBuyerScreen extends StatefulWidget {
  ...
  const DetailOrderBuyerScreen({required this.transactionId, super.key});
...
class DetailOrderBuyerScreenState extends State<DetailOrderBuyerScreen> {
  ...
  Future<void> takeScreenshot() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Failed to take screenshot: $e')));
    }
  }
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        notifier.detailOrderData.invoice.toString(),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          color: ColorResources.black,
                        ),
                      ...
                      notifier.detailOrderData.expire == null
                          ? const SizedBox()
                          : notifier.detailOrderData.orderStatus ==
                                "WAITING_PAYMENT"
                          ? Container(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        formatDateDDMMYYYY(notifier.detailOrderData.createdAt!),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      Container(
                        ...
                        child: Text(
                          orderStatus(
                            notifier.detailOrderData.orderStatus.toString(),
                          ),
                          style: robotoRegular.copyWith(
                            fontWeight: FontWeight.bold,
                            fontSize: Dimensions.fontSizeSmall,
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          item.waybill == "-"
                              ...
                              : CustomButton(
                                  onTap: () {
                                    // Navigator.push(context, MaterialPageRoute(builder: (context) => TrackingScreen(waybill: item.waybill)));
                                  },
                                  isBorderRadius: true,
                                  isBoxShadow: false,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        notifier.detailOrderData.paymentCode!.toUpperCase(),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                          fontWeight: FontWeight.bold,
                        ),
                  ...
                  notifier.detailOrderData.paymentCode == "gopay" ||
                          notifier.detailOrderData.paymentCode == "shopee" ||
                          notifier.detailOrderData.paymentCode == "dana" ||
                          notifier.detailOrderData.paymentCode == "ovo"
                      ? notifier.detailOrderData.orderStatus == "DELIVERED" ||
                                notifier.detailOrderData.orderStatus == "REFUND"
                            ? const SizedBox()
                            : Center(
                      ...
                      : Row(
                          ...
                          children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          notifier.detailOrderData.paymentAccess
                                              .toString(),
                                          style: robotoRegular.copyWith(
                                            fontSize:
                                                Dimensions.fontSizeDefault,
                            ...
                            Text(
                              notifier.detailOrderData.paymentAccess.toString(),
                              style: robotoRegular.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                fontWeight: FontWeight.bold,
                              ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        formatCurrency(notifier.detailOrderData.totalCost!),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                          fontWeight: FontWeight.bold,
                          color: ColorResources.black,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        notifier.detailOrderData.paymentCode == "gopay" ||
                                notifier.detailOrderData.paymentCode ==
                                    "shopee" ||
                                notifier.detailOrderData.paymentCode ==
                                    "dana" ||
                                notifier.detailOrderData.paymentCode == "ovo"
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        formatCurrency(notifier.detailOrderData.totalPrice!),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                          fontWeight: FontWeight.bold,
                          color: ColorResources.black,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        formatCurrency(
                          notifier.detailOrderData.totalPrice! +
                              notifier.detailOrderData.totalCost! +
                              (notifier.detailOrderData.paymentCode ==
                                          "gopay" ||
                                      notifier.detailOrderData.paymentCode ==
                                          "shopee" ||
