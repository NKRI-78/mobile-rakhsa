      ...
      setState(() {
        String price =
            CurrencyTextInputFormatter.currency(
              ...
              ecommerceProvider.productDetailData.product!.price.toString(),
            );

        categoryId =
            ecommerceProvider.productDetailData.product?.category.id ?? "-";

        categoryC = TextEditingController(
          text: isLoading
              ? ""
              : ecommerceProvider.productDetailData.product?.category.name ??
                    "-",
        );
        nameC = TextEditingController(
          text: isLoading
              ? ""
              : ecommerceProvider.productDetailData.product?.title ?? "-",
        );
        priceC = TextEditingController(text: isLoading ? "" : price);
        stockC = TextEditingController(
          text: isLoading
              ? ""
              : ecommerceProvider.productDetailData.product?.stock.toString() ??
                    "-",
        );
        weightC = TextEditingController(
          text: isLoading
              ? ""
              : ecommerceProvider.productDetailData.product?.weight
                        .toString() ??
                    "-",
        );
        descC = TextEditingController(
          text: isLoading
              ? ""
              : ecommerceProvider.productDetailData.product?.caption ?? "-",
        );
      });

      for (ProductMedia media
          in ecommerceProvider.productDetailData.product!.medias) {
