...
abstract class KbriRepository {
  Future<Either<Failure, KbriInfoModel>> infoKbriStateId({required String stateId});
  Future<Either<Failure, KbriInfoModel>> infoKbriStateName({required String stateName});
