          ...
          Text.rich(
            TextSpan(
              ...
              children: [
                ...
                const TextSpan(
                  text: 'Paspor dan Visa: Pastikan paspor memiliki masa berlaku yang cukup, biasanya minimal 6 bulan sebelum tanggal kedaluwarsa. Sesuaikan juga dengan persyaratan visa di negara tujuan.\n'
                ...
                const TextSpan(
                  text: 'Catat alamat, nomor telepon, dan informasi kontak lainnya dari KBRI atau Konsulat RI di negara tujuan Anda. Informasi ini penting untuk keperluan darurat, seperti kehilangan paspor, mengalami kecelakaan, atau situasi hukum lainnya.\n\n',
                ),

                TextSpan(
                  text: '3. Pengetahuan tentang Hukum dan Aturan Setempat\n',
                  style: robotoRegular.copyWith(fontWeight: FontWeight.bold),
                ),
                const TextSpan(
                  text: 'Hukum Lokal: Pahami hukum setempat, terutama yang berbeda dengan hukum di Indonesia. Hal ini meliputi peraturan tentang obat-obatan, alkohol, adat istiadat, dan aturan berpakaian.\n'
                ...
                const TextSpan(
                  text: 'Vaksinasi: Pastikan mematuhi persyaratan vaksinasi atau pemeriksaan kesehatan lainnya di negara tujuan, termasuk persyaratan COVID-19.\n'
                ...
                const TextSpan(
                  text: 'Pembatasan Uang Tunai: Beberapa negara memiliki batasan jumlah uang tunai yang dapat dibawa masuk. Pastikan Anda mengetahui dan mematuhi aturan ini.\n'
                ...
                const TextSpan(
                  text: 'Peredaran Narkotika: Banyak negara memiliki hukuman berat untuk pelanggaran terkait narkotika. Hindari membawa, menggunakan, atau terlibat dalam perdagangan narkoba.\n'
                ...
                TextSpan(
                  text: '7. Perlindungan Terhadap Eksploitasi atau Penipuan\n',
                  style: robotoRegular.copyWith(fontWeight: FontWeight.bold),
                ),
                const TextSpan(
                  text: 'Pekerja Migran: WNI yang bekerja di luar negeri disarankan untuk selalu berkomunikasi dengan KBRI atau Konsulat RI guna melaporkan keberadaan dan status kerja mereka.\n'
                      'Penipuan: Hindari ajakan investasi atau bisnis yang mencurigakan, terutama yang melibatkan pihak asing yang belum dikenal.\n\n',
                ),

                TextSpan(
                  text: '8. Langkah Darurat jika Menghadapi Masalah Hukum\n',
                  style: robotoRegular.copyWith(fontWeight: FontWeight.bold),
                ),
                const TextSpan(
                  text: 'Lapor ke KBRI: Jika menghadapi masalah hukum seperti penahanan, kehilangan paspor, atau menjadi korban tindak kriminal, segera laporkan ke KBRI atau Konsulat RI untuk mendapat bantuan.\n'
                ...
                const TextSpan(
                  text: 'Lapor Diri: Beberapa negara meminta WNI yang tinggal dalam jangka waktu lama untuk melapor diri ke KBRI atau Konsulat RI. Ini juga membantu KBRI menghubungi Anda dalam situasi darurat.\n'
                ...
                const TextSpan(
                  text: 'Asuransi Kesehatan dan Perjalanan: Memiliki asuransi perjalanan yang mencakup masalah kesehatan, kecelakaan, dan penggantian biaya perjalanan jika terjadi pembatalan atau penundaan adalah langkah penting dalam perlindungan diri.\n'
