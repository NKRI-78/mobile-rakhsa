...
class PPOBDetailPaketDataPage extends StatefulWidget {
  ...
  final String title;
  const PPOBDetailPaketDataPage({required this.title, super.key});

  @override
  State<PPOBDetailPaketDataPage> createState() =>
      PPOBDetailPaketDataPageState();
}
                          ...
                          Expanded(
                            ...
                            child: Bouncing(
                              onPress: () async {
                                ...
                                // getC.text = contact.phoneNumber!.number!
                                //     .replaceAll(RegExp("[()+\\s-]+"), "");
                                // if (!mounted) return;
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    right: 0.0,
                                    child: Image.asset(
                                      'assets/image/icons/ic-coin.png',
                                      width: 50.0,
                                      height: 50.0,
                                    ),
                                  ),
