...
class PPOBPageState extends State<PPOBPage> {
  ...
  void onChangeCategories({required String type, required int i}) {
    setState(() {
      selectedIndex = i;
      selectedType = type;
    });
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: CustomButton(
              ...
              : () {
                  if (getC.text.length < 10) {
                    ShowSnackbar.snackbarErr(
                      "Nomor ponsel minimum 10 atau 13 digit",
                    );
                    return;
                  }
                                        ...
                                        Consumer<PaymentChannelProvider>(
                                          builder:
                                              (
                                                ...
                                                PaymentChannelProvider notifier,
                                                Widget? child,
                                              ) {
                                                return Text(
                                                  notifier.paymentName.isEmpty
                                                      ? "Belum ada"
                                                                  ...
                                                                  return InkWell(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: Row(
                                                                        ...
                                                                        children: [
                                                                          Image.asset(
                                                                            "assets/images/icons/${paymentData.name.toLowerCase() == "mandiri"
                                                                                ? "ic-mandiri.png"
                              ...
                              Container(
                                ...
                                child: Selector<PaymentChannelProvider, String>(
                                  selector:
                                      (
                                        BuildContext context,
                                        PaymentChannelProvider provider,
                                        ...
                                        return CustomButton(
                                          onTap: paymentCode.isEmpty
                                              ...
                                              : () async {
                                                  ...
                                                  GeneralModal.infoV2(
                                                    msg:
                                                        "Terimakasih, Segera lakukan pembayaran Anda, detail info mengenai pembayaran terlampir pada notifikasi.",
                                                  );
                                                },
                                          isBorder: false,
                                          isBorderRadius: true,
          ...
          isBorder: false,
          isBorderRadius: true,
          btnColor: productId == "" ? greyDescColor : primaryColor,
          btnTxt: "Selanjutnya",
        ),
      ),
      body: Container(
          ...
          Expanded(
            ...
            child: Bouncing(
              onPress: () async {
                ...
                //   getC.text = contact.phoneNumber!.number!.replaceAll(
                //     RegExp("[()+\\s-]+"),
                //     "",
                //   );
