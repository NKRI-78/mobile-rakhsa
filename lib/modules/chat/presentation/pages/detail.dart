...
import 'package:rakhsa/modules/chat/presentation/pages/expire.dart';
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      Container(
                        ...
                        child: Text(
                          notifier.inbox.field6.toString(),
                          style: robotoRegular.copyWith(
                            color: ColorResources.black,
                            fontSize: Dimensions.fontSizeDefault,
                            fontWeight: FontWeight.bold,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${notifier.inbox.description.toString()}, -",
                                  style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeDefault,
                                    color: ColorResources.black,
                                  ),
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () async {
                                          ...
                                          ShowSnackbar.snackbarDefault(
                                            "${notifier.inbox.link.toString()} disalin",
                                          );
                                        },
