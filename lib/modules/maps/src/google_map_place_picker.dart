...
typedef SelectedPlaceWidgetBuilder =
    Widget Function(
...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  _searchByCameraLocation(PlaceProvider provider) async {
    ...
    final GeocodingResponse response = await provider.geocoding
        .searchByLocation(
          Location(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text("Select here", style: TextStyle(fontSize: 16)),
            onPressed: () {
